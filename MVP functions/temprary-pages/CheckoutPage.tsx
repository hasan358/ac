...
const chatData: Record<string, { title: string; cost: number; id: string }> = {
  'paid-ex': {
    title: 'Paid Example',
    cost: 9.99,
    id: 'paid-ex'
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative bg-gradient-to-br from-black to-gray-800 h-48 px-12 flex items-center">
        <h1 className="text-4xl text-white font-semibold">{chat.title}</h1>
      </div>

      {/* Секция оплаты */}
      <div className="max-w-4xl mx-auto px-4 mt-10">
        <h2 className="text-2xl text-black font-semibold mb-2">${chat.cost}/month</h2>
